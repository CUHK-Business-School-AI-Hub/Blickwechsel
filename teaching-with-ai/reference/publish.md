<!-- Generated from src/safe-to-publish/SKILL.md - do not edit this file.
...
`reference/case.md` produces the material both halves of this protect.
`reference/verify.md` checks the citations and figures a gate cannot settle by
arithmetic.
